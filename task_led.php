...
print("<th>Task</th>");
print("<th>Status</th>");
print("<th>Click once to>NOTIFY</th>");
print("</tr>");
...
while ($db_field = mysqli_fetch_assoc($result)) {
	...
	if($indi ==""){
		print("<td align = 'center' width = '200'><font color = 'blue'>do the task above</font>");
	...
	if($indi_stat == ""){
		print("<td align = 'center' width = '80'><b><font color = 'blue'>not yet!</font></b></td>");
	}
	else{
		if($indi_stat == 0){
			$indi_stat = "pending";
