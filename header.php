...
<head>
    ...
    <title><?php echo $user;?> Jobs and Oppotunities :TMS</title>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href = "manage_user.php"><i class="fa fa-bar-chart-o fa-fw"></i>Trainees And Supervisors</span></a> 
                        </li>
                        <li>
                            <a href = "group_task.php"><i class="fa fa-table fa-fw"></i>Tasks</a>
                        </li>
                        <li>
